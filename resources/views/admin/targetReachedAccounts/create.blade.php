...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.targetReachedAccount.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.target-reached-accounts.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('metric_info') ? 'is-invalid' : '' }}" type="text" name="metric_info" id="metric_info" value="{{ old('metric_info', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rules_reached') ? 'is-invalid' : '' }}" type="text" name="rules_reached" id="rules_reached" value="{{ old('rules_reached', '') }}" required>
