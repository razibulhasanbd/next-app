...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.typeform.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.typeforms.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="payments_for">{{ trans('cruds.typeform.fields.payments_for') }}</label>
                <input class="form-control {{ $errors->has('payments_for') ? 'is-invalid' : '' }}" type="text" name="payments_for" id="payments_for" value="{{ old('payments_for', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('funding_package') ? 'is-invalid' : '' }}" type="text" name="funding_package" id="funding_package" value="{{ old('funding_package', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('funding_amount') ? 'is-invalid' : '' }}" type="text" name="funding_amount" id="funding_amount" value="{{ old('funding_amount', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('paid_amount') ? 'is-invalid' : '' }}" type="text" name="paid_amount" id="paid_amount" value="{{ old('paid_amount', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('payment_verification') ? 'is-invalid' : '' }}" name="payment_verification" id="payment_verification">
                    ...
                    @foreach(App\Models\Typeform::PAYMENT_VERIFICATION_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('payment_verification', '0') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('denied_at') ? 'is-invalid' : '' }}" type="text" name="denied_at" id="denied_at" value="{{ old('denied_at') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('referred_by') ? 'is-invalid' : '' }}" type="text" name="referred_by" id="referred_by" value="{{ old('referred_by') }}">
