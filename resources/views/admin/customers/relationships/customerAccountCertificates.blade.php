...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-customerAccountCertificates">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-customerAccountCertificates:not(.ajaxTable)').DataTable({ buttons: dtButtons })
