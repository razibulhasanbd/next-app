            ...
            <thead>
                ...
                <tr>
                    ...
                    <td>
                        <select class="search">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach($model_varients as $key => $item)
                                <option value="{{ $item->name }}">{{ $item->name }}</option>
                            @endforeach
                        </select>
                    </td>
                    ...
                    <td>
                        <select class="search" strict="true">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach(App\Models\Product::STATUS_RADIO as $key => $item)
...
{ data: 'model_varient_name', name: 'model_varient.name' },
{ data: 'plan_title', name: 'plan.title' },
{ data: 'buy_price', name: 'buy_price' },
{ data: 'topup_price', name: 'topup_price' },
{ data: 'reset_price', name: 'reset_price' },
