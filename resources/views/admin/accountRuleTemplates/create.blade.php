...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.accountRuleTemplate.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.account-rule-templates.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('default_value') ? 'is-invalid' : '' }}" type="text" name="default_value" id="default_value" value="{{ old('default_value', '') }}" required>
