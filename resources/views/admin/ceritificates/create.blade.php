...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.ceritificate.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.ceritificates.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('html_markup') ? 'is-invalid' : '' }}" type="text" name="html_markup" id="html_markup" value="{{ old('html_markup', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input required type="file" class="form-control" name="demo_image">
                <small class="small font-italic">Example: jpeg,jpg,png. max:500 kb</small>
            </div>
            <div class="form-group">
