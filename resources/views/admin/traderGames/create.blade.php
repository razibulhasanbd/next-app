...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.traderGame.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.trader-games.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="dashboard_user">{{ trans('cruds.traderGame.fields.dashboard_user') }}</label>
                <input class="form-control {{ $errors->has('dashboard_user') ? 'is-invalid' : '' }}" type="number" name="dashboard_user" id="dashboard_user" value="{{ old('dashboard_user', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dashboard_email') ? 'is-invalid' : '' }}" type="email" name="dashboard_email" id="dashboard_email" value="{{ old('dashboard_email') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pnl') ? 'is-invalid' : '' }}" type="number" name="pnl" id="pnl" value="{{ old('pnl', '') }}" step="0.01">
                @if($errors->has('pnl'))
                    <div class="invalid-feedback">
                        {{ $errors->first('pnl') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mental_score') ? 'is-invalid' : '' }}" type="text" name="mental_score" id="mental_score" value="{{ old('mental_score', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tactical_score') ? 'is-invalid' : '' }}" type="text" name="tactical_score" id="tactical_score" value="{{ old('tactical_score', '') }}">
