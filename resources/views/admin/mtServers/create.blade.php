...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.mtServer.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.mt-servers.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('server') ? 'is-invalid' : '' }}" type="text" name="server" id="server" value="{{ old('server', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('friendly_name') ? 'is-invalid' : '' }}" type="text" name="friendly_name" id="friendly_name" value="{{ old('friendly_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('trading_server_type') ? 'is-invalid' : '' }}" type="text" name="trading_server_type" id="trading_server_type" value="{{ old('trading_server_type', '') }}" required>
