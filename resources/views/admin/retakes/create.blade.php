...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.retake.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.retakes.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('retake_count') ? 'is-invalid' : '' }}" type="number" name="retake_count" id="retake_count" value="{{ old('retake_count', '0') }}" step="1" required>
