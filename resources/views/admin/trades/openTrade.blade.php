...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.trade.open_trade') }} {{ trans('global.list') }}
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <select class="search">
                            ...
                            @foreach($getAllPackage as $key => $item)
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.trades.openTrade') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'account.plan.package.name', name: 'account.plan.package.name' },
