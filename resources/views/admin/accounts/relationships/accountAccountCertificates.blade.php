...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-accountAccountCertificates">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-accountAccountCertificates:not(.ajaxTable)').DataTable({ buttons: dtButtons })
