...
class ArchivedPaymentExport implements FromCollection, WithHeadings
{
    /**
    ...
    */
    ...
    {
      $typeForm = Typeform::whereNotNull('archived_at')->whereBetween('created_at', [request()->startDate, request()->endDate])->get();
